...
public class GUIApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(GUIApplication.class.getResource("/org/humeniuc/hello-view.fxml"));
        ...
        stage.sizeToScene();
        InputStream icoResource = GUIApplication.class.getResourceAsStream("/org/humeniuc/imgs/math_ico.png");
        Image ico = null;
